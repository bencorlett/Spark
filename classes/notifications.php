...
class Notifications extends \Object {
	 ...
	 * @var	string
	 */
	protected static $_view_name = 'notifications/default';
	...
	public static function __callStatic($method, array $arguments)
	{
		...
		if (in_array($method, static::$_allowable_types)) return static::add($method, call_user_func_array('sprintf', $arguments));
